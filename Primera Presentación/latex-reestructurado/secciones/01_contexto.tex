...
La explotación de esa información sigue la cadena de la figura~\ref{fig:cadena}: se registra la respuesta del terreno en varias posiciones de una línea, se transforma el conjunto de trazas al dominio frecuencia–velocidad de fase, se extrae de esa imagen la curva de dispersión observada $c_R^{\mathrm{obs}}(f)$ y se resuelve el problema inverso buscando el modelo estratificado que la reproduzca \citep{Park1998,Park1999,Xia1999}.
