...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{sincronizacion_fase.png}
...
La tabla~\ref{tab:puente} resume esa derivación y funciona además como mapa de lectura del resto del documento: la columna de decisiones anticipa lo que la sección 9 desarrolla, y la de evidencia remite a las secciones 10 y 11, donde cada afirmación se sostiene o se declara pendiente.
