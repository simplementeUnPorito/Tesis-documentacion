...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{normalizado_cadena_pga_adc.png}
\caption{Identificación de la cadena PGA$\to$ADC, que es la fila destacada de la
tabla~\ref{tab:identificacion}, con las curvas normalizadas a su propio máximo. De arriba abajo: magnitud,
fase y coherencia local. Se muestran la medición cruda, la procesada, el modelo
identificado y el modelo nominal del PSoC con los componentes actuales.}
\end{figure*}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{geometria_campanas.png}
...
La identificación de la tabla~\ref{tab:identificacion} verifica el requerimiento de fase de la sección 8 para una unidad y sobre casi cuatro décadas, con tres reservas: no hay medición extremo a extremo que incluya al geófono, la dinámica subsónica del compensador no resulta observable pese a existir puntos allí, y no se midió la dispersión entre placas.
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{contenido_baja_frecuencia.png}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{gather_sintetizado.png}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{masw_resultado.png}
\caption{Resultado de la campaña. Izquierda: puntos extraídos de la curva de dispersión contra la curva teórica del modelo invertido. Derecha: perfil $V_S(z)$ del modelo invertido.}
\end{figure*}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{vs_vs_sev.png}
...
\begin{figure*}[!tb]
\centering
\includegraphics[width=\textwidth,keepaspectratio]{roadmap_validacion.png}
