...
\begin{figure*}[!tb]
\centering
\includegraphics[width=0.86\textwidth,keepaspectratio]{arquitectura_vigente.png}
\caption{Arquitectura vigente del sistema y frontera entre el camino determinista de muestra y las funciones de calibración, comunicación y almacenamiento.}
\end{figure*}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=\columnwidth,keepaspectratio]{respuesta_sm24_modelo.png}
\caption{Respuesta nominal del SM-24 en circuito abierto, con las formas referidas a velocidad y a aceleración sobre los mismos ejes. Bajo $f_n$ caen a razón de 40 y 20 dB por década respectivamente; son dos referencias de la misma tensión de salida, no dos modos de funcionamiento.}
\end{figure}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=\columnwidth,keepaspectratio]{AnalogPathFinal_trim.png}
\caption{Cadena analógica implementada: entrada instrumental y ganancia programable, rama pasabanda de compensación, sumador y filtrado pasa-bajos previo al convertidor.}
\end{figure}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=\columnwidth,keepaspectratio]{extension_banda.png}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=\columnwidth,keepaspectratio]{flujo_calibracion_horizontal_usuario.png}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=\columnwidth,keepaspectratio]{DigitalPathFinal_trim.png}
\caption{Camino digital implementado en el PSoC: convertidor, filtro FIR por hardware, canales DMA y bloque de control descrito en lógica programable.}
\end{figure}
...
\begin{figure}[!tb]
\centering
\includegraphics[width=\columnwidth,keepaspectratio]{repetibilidad_fuente.png}
