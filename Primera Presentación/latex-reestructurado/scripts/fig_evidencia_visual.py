...
# ------------------------------------------------------------------- teoria
fig, axes = plt.subplots(1, 3, figsize=(6.30, 2.20), dpi=300)
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(6.30, 2.60), dpi=300)
zeta = 0.25
...
if False: fig.suptitle("Modelo nominal del geófono SM-24", x=0.04, ha="left",
...
fig, axes = plt.subplots(3, 1, figsize=(6.30, 3.80), dpi=300, sharex=True)
...
fig, axes = plt.subplots(len(chosen), 2, figsize=(6.30, 4.60), dpi=300,
...
fig, (ax1, ax2) = plt.subplots(1, 2, figsize=(6.30, 3.20), dpi=300,
...
# ---------------------------------------------------------- flujo del sistema
fig, ax = plt.subplots(figsize=(6.30, 1.90), dpi=300)
ax.set_xlim(0, 15)
ax.set_ylim(0, 4)
ax.axis("off")
steps = [
...
# -------------------------------------------------------------- comparativas
fig, ax = plt.subplots(figsize=(6.30, 2.70), dpi=300)
ax.set_xlim(0, 10.8)
ax.set_ylim(0, 5)
ax.axis("off")
methods = [
...
# ---------------------------------------------------------- tablero de cierre
fig, ax = plt.subplots(figsize=(6.30, 2.75), dpi=300)
ax.set_xlim(0, 12)
ax.set_ylim(0, 5)
ax.axis("off")
items = [
...
# -------------------------------------------------------------- hoja de ruta
fig, ax = plt.subplots(figsize=(6.30, 2.90), dpi=300)
ax.set_xlim(0, 10)
ax.set_ylim(0, 10)
...
if False: ax.set_title("Hoja de ruta: primero cerrar la evidencia, despues escalar el hardware",
