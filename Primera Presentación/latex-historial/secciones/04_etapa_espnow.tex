...
\begin{figure}[ht]
\centering
\includegraphics[width=0.88\textwidth]{sincronizacion_fase.png}
\caption{Traducci\'on del desalineamiento temporal a error de fase. El presupuesto fija
el criterio de medici\'on; el \emph{jitter} de extremo a extremo del arreglo vigente
sigue pendiente de caracterizaci\'on.}
\end{figure}
...
entre pulsos mide la dispersi\'on de la ruta ESP-NOW$\to$callback$\to$GPIO de los
ESP32. En esta etapa se us\'o como \emph{proxy} de sincronizaci\'on, pero no incluye
la ruta completa hasta el inicio efectivo del ADC y no constituye una medici\'on
...
para el \textbf{martillo de impacto con sensor de fuerza PCB Piezotronics 086D20}, con cadena
