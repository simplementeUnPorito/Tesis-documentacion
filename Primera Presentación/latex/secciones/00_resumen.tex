...
inal\'ambrica multi-nodo con disparo coordinado y jerarqu\'ia de memoria de tres
niveles (RAM del ESP32, encadenado en RAM del PSoC y tarjeta SD), cuya
\textbf{integridad de captura y transferencia} se valid\'o durante 10 minutos; la
sincronizaci\'on de extremo a extremo de la topolog\'ia vigente a\'un debe medirse; (v) una auditor\'ia pre-campo sistem\'atica que
detect\'o y corrigi\'o varios defectos cr\'iticos de sincronizaci\'on; y (vi) campa\~nas de
medici\'on en campo mediante apertura sint\'etica con un ge\'ofono m\'ovil, procesamiento
MASW y una arquitectura de inversi\'on con motores seleccionables. El estado persistido
que se reporta usa una curva etiquetada como modo~0 mediante un
\emph{port} num\'erico de MASWavesPy; la validaci\'on multimodal comparativa queda abierta.
