...
sometido al congreso URUCON~2026. El env\'io constituye una solicitud de evaluaci\'on
externa; no se presenta como revisi\'on recibida mientras no exista dictamen.

\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{flujo_adquisicion_masw.png}
\caption{Lectura visual del proyecto completo. Cada bloque genera un artefacto
inspeccionable: impacto de referencia, registros crudos y filtrados, alineaci\'on,
\emph{gather}, imagen de dispersi\'on y perfil exploratorio. La preservaci\'on del crudo
permite revisar las decisiones posteriores sin alterar la adquisici\'on original.}
\label{fig:flujo-global}
\end{figure}
