...
Se incorpor\'o el \textbf{modelo del operacional real} ($A_0=\SI{90}{\decibel}$,
$f_p=\SI{8}{\mega\hertz}$) y se valid\'o contra medici\'on. Se atac\'o el dise\~no del
...
aceler\'ometro PCB~Piezotronics~086D20. Poco despu\'es se tom\'o una decisi\'on de arquitectura
...
\midrule
Filtro pasivo RC de entrada & Reemplazado por FIR digital con decimaci\'on: m\'as flexible, sin tolerancias de componentes & abr. \\
...
Compensaci\'on anal\'ogica activa del ge\'ofono & Complejidad y sensibilidad frente a la alternativa digital & abr.--may. \\
Filtro adaptativo LMS para \emph{notch} & Reemplazado por m\'inimos cuadrados, m\'as predecible & jun. \\
\emph{Notch} arm\'onico en el cliente web & Simplificaci\'on del \emph{pipeline}; se trata en post-proceso & jun. \\
Enlace SPI PSoC$\leftrightarrow$ESP32 & Migrado a UART por robustez e integraci\'on con el protocolo & may. \\
