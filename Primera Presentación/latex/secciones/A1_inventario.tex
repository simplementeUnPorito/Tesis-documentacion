...
\texttt{AcondicionamientoMartillo} & Proyecto PSoC del nodo martillo (aceler\'ometro 086D20) \\
...
\texttt{masw\_inversion.py} & Inversi\'on multimodal (\texttt{evodcinv} sobre \texttt{disba}) \\
...
Art\'iculo URUCON~2026 & Comunicaci\'on cient\'ifica sobre el DA-AFE, con revisi\'on \\
