...
\graphicspath{{../../Urucom_2026_compact/imagenes/}{../../calibration_fsm/}{imagenes/}{../latex-historial/figuras/}}
...
\input{secciones/02b_geofono}
\input{secciones/03_estado_del_arte}
\input{secciones/03b_topologias}
\input{secciones/04_arquitectura}
\input{secciones/05_desarrollo_cronologico}
\input{secciones/06_metodologia_validacion}
\input{secciones/07_resultados}
\input{secciones/08_trabajos_futuros}
\input{secciones/09_conclusiones}
\appendix
\input{secciones/A1_inventario}
\input{secciones/A2_preguntas}
