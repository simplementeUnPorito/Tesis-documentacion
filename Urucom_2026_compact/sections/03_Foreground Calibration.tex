...
\begin{figure}[!t]
    \centering
    \includegraphics[width=0.90\columnwidth]{imagenes/psoc_foreground_calibration_flow_compressed-Foreground calibration flow.drawio.png}
...
\begin{figure*}[t]
	\centering
	\includegraphics[width=1.00\textwidth]{imagenes/DigitalPath_Page5_trim.png}
